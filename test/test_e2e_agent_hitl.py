...
def start_interrupted_turn(tag: str) -> dict:
    result = env.run_agent("spaine", message=PROMPT, mode="chat", timeout_s=600)
...
def part_a_resume_with_decisions() -> None:
    ...
    second = env.run_agent("spaine", thread_id=first["thread_id"], decisions=decisions, timeout_s=600)
