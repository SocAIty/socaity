...
class video_background_remover_appender(FastSDK):
    """
    Generated client for video_background_remover_appender
    """
    def __init__(self, api_key: str = None):
        super().__init__(service_name_or_id="a3850545-3f12-4a0d-af99-d5b34caae4e0", api_key=api_key)
    ...
    def predict(self, input_video: Union[MediaFile, str, bytes], fps: int = 0, color: str = '#00FF00', bg_mode: str = 'cover', bg_type: str = 'Color', video_handling: str = 'loop', bg_image: Optional[Union[MediaFile, str, bytes]] = None, bg_video: Optional[Union[MediaFile, str, bytes]] = None, **kwargs):
        ...
        """
        return self.submit_job("/predict", input_video=input_video, fps=fps, color=color, bg_mode=bg_mode, bg_type=bg_type, video_handling=video_handling, bg_image=bg_image, bg_video=bg_video, **kwargs)
