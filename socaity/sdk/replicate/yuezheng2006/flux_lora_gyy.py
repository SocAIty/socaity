...
class flux_lora_gyy(FastClient):
    """
    Generated client for yuezheng2006/flux-lora-gyy
    """
    def __init__(self, api_key: str = None):
        super().__init__(service_name_or_id="a17dd692-ee77-402f-ad1a-6dada7b6d4c6", api_key=api_key)
