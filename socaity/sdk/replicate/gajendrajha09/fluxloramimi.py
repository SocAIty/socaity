...
class fluxloramimi(FastClient):
    """
    Generated client for gajendrajha09/fluxloramimi
    """
    def __init__(self, api_key: str = None):
        super().__init__(service_name_or_id="1e3d2b70-2cad-4aeb-b149-cb8cf3bce307", api_key=api_key)
