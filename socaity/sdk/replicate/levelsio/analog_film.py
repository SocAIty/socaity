...
class analog_film(FastClient):
    """
    Generated client for levelsio/analog-film
    """
    def __init__(self, api_key: str = None):
        super().__init__(service_name_or_id="6059946d-2ec3-41e1-8933-bd6bcecb797f", api_key=api_key)
