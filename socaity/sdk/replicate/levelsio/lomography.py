...
class lomography(FastClient):
    """
    Generated client for levelsio/lomography
    """
    def __init__(self, api_key: str = None):
        super().__init__(service_name_or_id="ef8debaa-dbb4-4009-a909-4a95894ee929", api_key=api_key)
