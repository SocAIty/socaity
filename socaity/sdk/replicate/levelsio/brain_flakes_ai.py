...
class brain_flakes_ai(FastClient):
    """
    Generated client for levelsio/brain-flakes-ai
    """
    def __init__(self, api_key: str = None):
        super().__init__(service_name_or_id="165efdb6-fd6d-47a5-8045-3728b8272784", api_key=api_key)
