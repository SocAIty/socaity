...
class flux_shapes(FastClient):
    """
    Generated client for andreasjansson/flux-shapes
    """
    def __init__(self, api_key: str = None):
        super().__init__(service_name_or_id="929ba1b8-1e23-4250-837d-891ace094202", api_key=api_key)
