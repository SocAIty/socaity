...
class flux_me(FastClient):
    """
    Generated client for andreasjansson/flux-me
    """
    def __init__(self, api_key: str = None):
        super().__init__(service_name_or_id="cc6bf755-8f7e-4650-a9df-79e1982f93dd", api_key=api_key)
