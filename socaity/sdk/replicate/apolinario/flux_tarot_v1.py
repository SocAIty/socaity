...
class flux_tarot_v1(FastClient):
    """
    Generated client for apolinario/flux-tarot-v1
    """
    def __init__(self, api_key: str = None):
        super().__init__(service_name_or_id="de8956f7-59aa-4a30-9f70-bb987fa74286", api_key=api_key)
