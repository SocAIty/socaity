...
class pen_lettering_flux_lora(FastClient):
    """
    Generated client for agusdor/pen-lettering-flux-lora
    """
    def __init__(self, api_key: str = None):
        super().__init__(service_name_or_id="eb963eef-450e-4268-8d92-d319bc0ddb93", api_key=api_key)
