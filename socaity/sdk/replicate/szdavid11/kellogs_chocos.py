...
class kellogs_chocos(FastClient):
    """
    Generated client for szdavid11/kellogs-chocos
    """
    def __init__(self, api_key: str = None):
        super().__init__(service_name_or_id="25817a3c-3843-4063-9f4b-89411c04e185", api_key=api_key)
