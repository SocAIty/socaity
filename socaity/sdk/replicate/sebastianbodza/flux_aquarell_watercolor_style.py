...
class flux_aquarell_watercolor_style(FastClient):
    """
    Generated client for sebastianbodza/flux-aquarell-watercolor-style
    """
    def __init__(self, api_key: str = None):
        super().__init__(service_name_or_id="8970473a-8b68-4b85-94ae-bc43fa123bab", api_key=api_key)
