...
class puri(FastClient):
    """
    Generated client based on puribogdan/puri format
    """
    def __init__(self, api_key: str = None):
        super().__init__(service_name_or_id="45f3945f-cb7f-4056-a8e5-f82616be97ca", api_key=api_key)
