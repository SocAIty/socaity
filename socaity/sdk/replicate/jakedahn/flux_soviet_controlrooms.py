...
class flux_soviet_controlrooms(FastClient):
    """
    Generated client for jakedahn/flux-soviet-controlrooms
    """
    def __init__(self, api_key: str = None):
        super().__init__(service_name_or_id="91b597e7-ee0c-4e55-9cbd-702a20425b0d", api_key=api_key)
