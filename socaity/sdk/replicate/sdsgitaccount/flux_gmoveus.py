...
class flux_gmoveus(FastClient):
    """
    Generated client for sdsgitaccount/flux-gmoveus
    """
    def __init__(self, api_key: str = None):
        super().__init__(service_name_or_id="777e307c-fb52-4aca-a3ed-0ba57bcfb36b", api_key=api_key)
