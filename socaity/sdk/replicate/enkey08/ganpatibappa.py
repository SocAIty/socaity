...
class ganpatibappa(FastClient):
    """
    Generated client for enkey08/ganpatibappa
    """
    def __init__(self, api_key: str = None):
        super().__init__(service_name_or_id="cf494dcb-d275-49aa-8b9e-e7f1a06d2931", api_key=api_key)
