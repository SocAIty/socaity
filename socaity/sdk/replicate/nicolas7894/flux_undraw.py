...
class flux_undraw(FastClient):
    """
    Generated client for nicolas7894/flux-undraw
    """
    def __init__(self, api_key: str = None):
        super().__init__(service_name_or_id="c8534511-a458-48d7-a59d-1a1285a0088d", api_key=api_key)
