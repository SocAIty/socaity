...
class ai_skoda_octavia(FastClient):
    """
    Generated client based on imiroslav/ai-skoda-octavia format
    """
    def __init__(self, api_key: str = None):
        super().__init__(service_name_or_id="fde25844-a3d4-418f-bcb4-ee00a8ef443c", api_key=api_key)
