...
class controlnet_pose(FastSDK):
    """
    Generated client for controlnet_pose
    """
    def __init__(self, api_key: str = None):
        super().__init__(service_name_or_id="04d40832-f215-4109-8c0a-f5646d67c4d9", api_key=api_key)
