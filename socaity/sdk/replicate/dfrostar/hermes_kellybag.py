...
class hermes_kellybag(FastClient):
    """
    Generated client for dfrostar/hermes-kellybag
    """
    def __init__(self, api_key: str = None):
        super().__init__(service_name_or_id="03d9b9bc-643c-45f1-a286-0e87701b7d1a", api_key=api_key)
