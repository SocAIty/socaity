...
class iphone_camera_style(FastClient):
    """
    Generated client for qunash/iphone-camera-style
    """
    def __init__(self, api_key: str = None):
        super().__init__(service_name_or_id="a3a807f6-1e09-477b-98d8-a4fb969ceb70", api_key=api_key)
