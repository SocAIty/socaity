...
class circassian_culture_flux_3000_steps(FastClient):
    """
    Generated client for qunash/circassian-culture-flux-3000-steps
    """
    def __init__(self, api_key: str = None):
        super().__init__(service_name_or_id="983f25e7-7773-4564-9ecb-49c964b4384f", api_key=api_key)
