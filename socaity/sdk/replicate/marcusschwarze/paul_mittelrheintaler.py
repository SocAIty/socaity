...
class paul_mittelrheintaler(FastClient):
    """
    Generated client for marcusschwarze/paul-mittelrheintaler
    """
    def __init__(self, api_key: str = None):
        super().__init__(service_name_or_id="c050c966-cff0-484a-ae94-a5b8bcd507b1", api_key=api_key)
