...
class urban_narrative(FastClient):
    """
    Generated client for digitaljohn/urban-narrative
    """
    def __init__(self, api_key: str = None):
        super().__init__(service_name_or_id="7667b10a-0501-47c6-b32d-aadf3c42061e", api_key=api_key)
