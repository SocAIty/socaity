...
class mad2_flux_lora(FastClient):
    """
    Generated client for astronautdavid1/mad2-flux-lora
    """
    def __init__(self, api_key: str = None):
        super().__init__(service_name_or_id="15c4d478-aba2-470a-bd9a-24e33cecd437", api_key=api_key)
