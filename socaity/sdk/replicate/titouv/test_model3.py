...
class test_model3(FastClient):
    """
    Generated client for titouv/test-model3
    """
    def __init__(self, api_key: str = None):
        super().__init__(service_name_or_id="00275b1b-6bea-49ce-9f54-04f25dee29b1", api_key=api_key)
