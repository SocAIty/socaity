...
class florentino(FastClient):
    """
    Generated client for cristobalascencio/florentino
    """
    def __init__(self, api_key: str = None):
        super().__init__(service_name_or_id="7a100ec3-f92b-4fde-895e-9d8a3abc816c", api_key=api_key)
