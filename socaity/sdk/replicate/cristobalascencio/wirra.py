...
class wirra(FastClient):
    """
    Generated client for cristobalascencio/wirra
    """
    def __init__(self, api_key: str = None):
        super().__init__(service_name_or_id="ab402232-2971-4533-9dd0-bdcf7758a702", api_key=api_key)
