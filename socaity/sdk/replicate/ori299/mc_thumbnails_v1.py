...
class mc_thumbnails_v1(FastClient):
    """
    Generated client for ori299/mc-thumbnails-v1
    """
    def __init__(self, api_key: str = None):
        super().__init__(service_name_or_id="2df41f02-509a-4daa-aacb-f6dfa83e27a9", api_key=api_key)
