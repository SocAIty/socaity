...
class flux_mobile_ui(FastClient):
    """
    Generated client for justmalhar/flux-mobile-ui
    """
    def __init__(self, api_key: str = None):
        super().__init__(service_name_or_id="ec361ecc-aa50-45f1-a720-c0fe2f3b0940", api_key=api_key)
