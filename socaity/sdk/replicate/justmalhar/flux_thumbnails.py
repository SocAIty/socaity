...
class flux_thumbnails(FastClient):
    """
    Generated client for justmalhar/flux-thumbnails
    """
    def __init__(self, api_key: str = None):
        super().__init__(service_name_or_id="c2b4a301-c101-46a3-8f09-2024ca551de8", api_key=api_key)
