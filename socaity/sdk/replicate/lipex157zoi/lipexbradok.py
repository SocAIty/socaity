...
class lipexbradok(FastClient):
    """
    Generated client for lipex157zoi/lipexbradok
    """
    def __init__(self, api_key: str = None):
        super().__init__(service_name_or_id="03d99098-c5db-42ad-95ca-693a20555e90", api_key=api_key)
