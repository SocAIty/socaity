...
class newspaper_illustration(FastClient):
    """
    Generated client for tudortotolici/newspaper-illustration
    """
    def __init__(self, api_key: str = None):
        super().__init__(service_name_or_id="17cc7004-c643-405b-9548-f9b3ae128c3b", api_key=api_key)
