...
class archslra(FastClient):
    """
    Generated client based on grassyguru/archslra format
    """
    def __init__(self, api_key: str = None):
        super().__init__(service_name_or_id="d7633864-ccb0-4eff-b7a0-46078bd46bdc", api_key=api_key)
