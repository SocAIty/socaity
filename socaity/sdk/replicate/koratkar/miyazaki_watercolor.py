...
class miyazaki_watercolor(FastClient):
    """
    Generated client for koratkar/miyazaki-watercolor
    """
    def __init__(self, api_key: str = None):
        super().__init__(service_name_or_id="92805dd1-6e61-4298-a59b-bb89456ea12d", api_key=api_key)
