...
class fullbody(FastClient):
    """
    Generated client for tokaito14/fullbody
    """
    def __init__(self, api_key: str = None):
        super().__init__(service_name_or_id="5c6973cd-93be-4d62-9d84-50d92a42db9c", api_key=api_key)
