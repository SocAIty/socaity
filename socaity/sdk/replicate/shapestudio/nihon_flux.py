...
class nihon_flux(FastClient):
    """
    Generated client for shapestudio/nihon-flux
    """
    def __init__(self, api_key: str = None):
        super().__init__(service_name_or_id="4508b0ca-e351-4fd0-a44a-b51848fb9b11", api_key=api_key)
