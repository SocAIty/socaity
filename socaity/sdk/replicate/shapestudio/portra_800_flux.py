...
class portra_800_flux(FastClient):
    """
    Generated client for shapestudio/portra-800-flux
    """
    def __init__(self, api_key: str = None):
        super().__init__(service_name_or_id="b1ab7c26-2f34-467c-94c4-224aec122eac", api_key=api_key)
