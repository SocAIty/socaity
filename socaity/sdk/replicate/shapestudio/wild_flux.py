...
class wild_flux(FastClient):
    """
    Generated client for shapestudio/wild-flux
    """
    def __init__(self, api_key: str = None):
        super().__init__(service_name_or_id="ccc7558d-957f-4df0-af31-3e14f9e06fda", api_key=api_key)
