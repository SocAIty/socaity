...
class flux_wojak_v2(FastClient):
    """
    Generated client for marckohlbrugge/flux-wojak-v2
    """
    def __init__(self, api_key: str = None):
        super().__init__(service_name_or_id="a0318d0a-13ea-4e21-b64c-aa3d29b2f928", api_key=api_key)
