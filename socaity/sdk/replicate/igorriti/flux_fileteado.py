...
class flux_fileteado(FastClient):
    """
    Generated client for igorriti/flux-fileteado
    """
    def __init__(self, api_key: str = None):
        super().__init__(service_name_or_id="4b831f3a-6110-40fa-9ad2-07f53adb4734", api_key=api_key)
