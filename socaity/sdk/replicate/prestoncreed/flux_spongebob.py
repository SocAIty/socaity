...
class flux_spongebob(FastClient):
    """
    Generated client for prestoncreed/flux-spongebob
    """
    def __init__(self, api_key: str = None):
        super().__init__(service_name_or_id="19d751b7-b7ca-4138-bf42-71fe533ca4b5", api_key=api_key)
