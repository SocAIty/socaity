...
class moebius_flux_lora(FastClient):
    """
    Generated client for jamorphy/moebius-flux-lora
    """
    def __init__(self, api_key: str = None):
        super().__init__(service_name_or_id="9c9e64b3-6a16-4ba7-a896-38205a688941", api_key=api_key)
