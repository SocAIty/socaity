...
class flux_ghibsky_illustration(FastClient):
    """
    Generated client for aleksa-codes/flux-ghibsky-illustration
    """
    def __init__(self, api_key: str = None):
        super().__init__(service_name_or_id="95537b27-1bf6-4196-95b6-1b5267c3cef3", api_key=api_key)
