...
class kocchaga(FastClient):
    """
    Generated client for janghaludu/kocchaga
    """
    def __init__(self, api_key: str = None):
        super().__init__(service_name_or_id="737dc1e1-9916-4b93-87c9-8a3e84546ea9", api_key=api_key)
