...
class flux_texture_abstract_painting(FastClient):
    """
    Generated client for brunnolou/flux-texture-abstract-painting
    """
    def __init__(self, api_key: str = None):
        super().__init__(service_name_or_id="4af2e680-8821-4f2c-94f5-68c9fa2905f6", api_key=api_key)
