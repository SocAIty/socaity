...
class controlnet_x_ip_adapter_realistic_vision_v5(FastSDK):
    ...
    def predictions(self, prompt: str, eta: float = 0.0, max_width: int = 512, scheduler: str = 'DDIM', guess_mode: bool = False, int_kwargs: str = '', max_height: int = 512, num_outputs: int = 1, guidance_scale: float = 7.0, ip_adapter_ckpt: str = 'ip-adapter_sd15.bin', negative_prompt: str = 'Longbody, lowres, bad anatomy, bad hands, missing fingers, extra digit, fewer digits, cropped, worst quality, low quality', img2img_strength: float = 0.5, ip_adapter_weight: float = 1.0, sorted_controlnets: str = 'lineart, tile, inpainting', inpainting_strength: float = 1.0, num_inference_steps: int = 20, disable_safety_check: bool = False, film_grain_lora_weight: float = 0.0, tile_conditioning_scale: float = 1.0, add_more_detail_lora_scale: float = 0.5, detail_tweaker_lora_weight: float = 0.0, lineart_conditioning_scale: float = 1.0, scribble_conditioning_scale: float = 1.0, epi_noise_offset_lora_weight: float = 0.0, brightness_conditioning_scale: float = 1.0, inpainting_conditioning_scale: float = 1.0, color_temprature_slider_lora_weight: float = 0.0, seed: Optional[int] = None, mask_image: Optional[Union[str, MediaFile, bytes]] = None, tile_image: Optional[Union[str, MediaFile, bytes]] = None, img2img_image: Optional[Union[str, MediaFile, bytes]] = None, lineart_image: Optional[Union[str, MediaFile, bytes]] = None, scribble_image: Optional[Union[str, MediaFile, bytes]] = None, brightness_image: Optional[Union[str, MediaFile, bytes]] = None, inpainting_image: Optional[Union[str, MediaFile, bytes]] = None, ip_adapter_image: Optional[Union[str, MediaFile, bytes]] = None, negative_auto_mask_text: Optional[str] = None, positive_auto_mask_text: Optional[str] = None, **kwargs) -> APISeex:
        """
