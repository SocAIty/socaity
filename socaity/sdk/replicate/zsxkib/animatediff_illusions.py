...
class animatediff_illusions(FastSDK):
    """
    Generated client for animatediff_illusions
    """
    def __init__(self, api_key: str = None):
        super().__init__(service_name_or_id="6638a9ee-a39d-41cf-a6c2-14a80faf3315", api_key=api_key)
