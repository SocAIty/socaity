...
class yolo_world(FastSDK):
    ...
    def predictions(self, input_media: Union[str, MediaFile, bytes], nms_thr: float = 0.5, score_thr: float = 0.05, class_names: str = 'dog, eye, tongue, ear, leash, backpack, person, nose', max_num_boxes: int = 100, **kwargs) -> APISeex:
        """
