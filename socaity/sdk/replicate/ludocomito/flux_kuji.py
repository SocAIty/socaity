...
class flux_kuji(FastClient):
    """
    Generated client based on ludocomito/flux-kuji format
    """
    def __init__(self, api_key: str = None):
        super().__init__(service_name_or_id="7a68e463-652e-4500-ab7d-72ef3b3c8568", api_key=api_key)
