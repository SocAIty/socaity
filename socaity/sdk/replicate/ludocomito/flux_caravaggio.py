...
class flux_caravaggio(FastClient):
    """
    Generated client for ludocomito/flux-caravaggio
    """
    def __init__(self, api_key: str = None):
        super().__init__(service_name_or_id="62e2a6fe-6ee7-4ea9-95b1-a3a671f78383", api_key=api_key)
