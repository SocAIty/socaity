...
class fatherofdragons(FastClient):
    """
    Generated client for roelfrenkema/fatherofdragons
    """
    def __init__(self, api_key: str = None):
        super().__init__(service_name_or_id="b1517841-9a39-4575-be34-4124b162d270", api_key=api_key)
