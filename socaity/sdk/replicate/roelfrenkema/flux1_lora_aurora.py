...
class flux1_lora_aurora(FastClient):
    """
    Generated client for roelfrenkema/flux1-lora-aurora
    """
    def __init__(self, api_key: str = None):
        super().__init__(service_name_or_id="93c59977-a1f7-46ee-b643-a25f5bdb30fc", api_key=api_key)
