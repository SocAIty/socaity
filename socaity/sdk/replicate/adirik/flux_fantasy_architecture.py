...
class flux_fantasy_architecture(FastClient):
    """
    Generated client for adirik/flux-fantasy-architecture
    """
    def __init__(self, api_key: str = None):
        super().__init__(service_name_or_id="484a1e1f-e66f-4bd2-93d9-cc297e15197e", api_key=api_key)
