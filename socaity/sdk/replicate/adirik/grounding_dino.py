...
class grounding_dino(FastSDK):
    ...
    def predictions(self, box_threshold: float = 0.25, text_threshold: float = 0.25, show_visualisation: bool = True, image: Optional[Union[str, MediaFile, bytes]] = None, query: Optional[str] = None, **kwargs) -> APISeex:
        """
