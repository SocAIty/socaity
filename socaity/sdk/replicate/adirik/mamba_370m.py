...
class mamba_370m(FastClient):
    """
    Generated client for adirik/mamba-370m
    """
    def __init__(self, api_key: str = None):
        super().__init__(service_name_or_id="67bf7cf2-7ec9-4938-8864-1eeb82f173ce", api_key=api_key)
