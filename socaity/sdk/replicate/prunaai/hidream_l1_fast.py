...
class hidream_l1_fast(FastSDK):
    """
    Generated client for prunaai/hidream-l1-fast
    """
    def __init__(self, api_key: str = None):
        super().__init__(service_name_or_id="813450de-15b9-40b8-8a04-3cbcfde87b02", api_key=api_key)
    
    def predictions(self, prompt: str, seed: int = -1, model_type: str = 'fast', resolution: str = '1024 × 1024 (Square)', speed_mode: str = 'Lightly Juiced 🍊 (more consistent)', output_format: str = 'webp', output_quality: int = 100, **kwargs) -> APISeex:
        """
