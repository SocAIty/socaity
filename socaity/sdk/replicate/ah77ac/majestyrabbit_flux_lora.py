...
class majestyrabbit_flux_lora(FastClient):
    """
    Generated client for ah77ac/majestyrabbit-flux-lora
    """
    def __init__(self, api_key: str = None):
        super().__init__(service_name_or_id="24015d6e-4e8f-46f8-a6da-3fda927e87ea", api_key=api_key)
