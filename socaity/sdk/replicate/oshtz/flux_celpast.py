...
class flux_celpast(FastClient):
    """
    Generated client for oshtz/flux-celpast
    """
    def __init__(self, api_key: str = None):
        super().__init__(service_name_or_id="1a6efbb7-3459-4ba1-b230-3612d38978a8", api_key=api_key)
