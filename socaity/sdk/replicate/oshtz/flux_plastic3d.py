...
class flux_plastic3d(FastClient):
    """
    Generated client for oshtz/flux-plastic3d
    """
    def __init__(self, api_key: str = None):
        super().__init__(service_name_or_id="113b7b9d-d00c-4d03-8ae0-1fbab1a05be3", api_key=api_key)
