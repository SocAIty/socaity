...
class klm_lora_flux(FastClient):
    """
    Generated client for dcamsdev/klm-lora-flux
    """
    def __init__(self, api_key: str = None):
        super().__init__(service_name_or_id="a7212b1c-62e1-497d-ad96-22a7c59fa2c9", api_key=api_key)
