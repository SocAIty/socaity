...
class flux_mystic_animals(FastClient):
    """
    Generated client for halimalrasihi/flux-mystic-animals
    """
    def __init__(self, api_key: str = None):
        super().__init__(service_name_or_id="787a6558-1c6a-424d-b66d-56d88fbf6c65", api_key=api_key)
