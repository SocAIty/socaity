...
class flux_red_cinema(FastClient):
    """
    Generated client for halimalrasihi/flux-red-cinema
    """
    def __init__(self, api_key: str = None):
        super().__init__(service_name_or_id="4077ef2e-c692-4ff2-8c25-98b09b9e2162", api_key=api_key)
