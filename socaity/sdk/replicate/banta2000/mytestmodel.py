...
class mytestmodel(FastClient):
    """
    Generated client for banta2000/mytestmodel
    """
    def __init__(self, api_key: str = None):
        super().__init__(service_name_or_id="68a4b439-6202-456b-9631-67b8dab9cbe9", api_key=api_key)
