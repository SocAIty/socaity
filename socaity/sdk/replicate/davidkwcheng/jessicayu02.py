...
class jessicayu02(FastClient):
    """
    Generated client for davidkwcheng/jessicayu02
    """
    def __init__(self, api_key: str = None):
        super().__init__(service_name_or_id="a6278d2c-42a1-4782-a0f6-a225026a28f6", api_key=api_key)
