...
class pepsi_flux(FastClient):
    """
    Generated client for sigil-wen/pepsi-flux
    """
    def __init__(self, api_key: str = None):
        super().__init__(service_name_or_id="fc6d8d2c-9d04-4c34-acca-a25eb7d5426e", api_key=api_key)
