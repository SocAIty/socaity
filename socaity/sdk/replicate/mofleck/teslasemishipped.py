...
class teslasemishipped(FastClient):
    """
    Generated client for mofleck/teslasemishipped
    """
    def __init__(self, api_key: str = None):
        super().__init__(service_name_or_id="7b4a3378-4047-4c6b-9c81-05c090408a9d", api_key=api_key)
