...
class flux_raylene(FastClient):
    """
    Generated client for jarvis-labs2024/flux-raylene
    """
    def __init__(self, api_key: str = None):
        super().__init__(service_name_or_id="fa4ee09d-2bd9-4c2e-86a6-96a785790bea", api_key=api_key)
