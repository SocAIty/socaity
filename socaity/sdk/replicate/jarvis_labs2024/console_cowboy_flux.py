...
class console_cowboy_flux(FastClient):
    """
    Generated client for jarvis-labs2024/console-cowboy-flux
    """
    def __init__(self, api_key: str = None):
        super().__init__(service_name_or_id="e6b12057-afec-410a-91e6-6455cee5da78", api_key=api_key)
