...
class flux_appleseed(FastClient):
    """
    Generated client for jarvis-labs2024/flux-appleseed
    """
    def __init__(self, api_key: str = None):
        super().__init__(service_name_or_id="c9b2030e-808c-4226-839e-476b95bb8357", api_key=api_key)
