...
class libreintense(FastClient):
    """
    Generated client for someone12dd/libreintense
    """
    def __init__(self, api_key: str = None):
        super().__init__(service_name_or_id="0f941364-d58d-4d62-b64a-ea7da3034e53", api_key=api_key)
