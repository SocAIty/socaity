...
class muskoil1(FastClient):
    """
    Generated client for someone12dd/muskoil1
    """
    def __init__(self, api_key: str = None):
        super().__init__(service_name_or_id="feb39fd5-d5a1-4bb4-b612-bb12b3d9e556", api_key=api_key)
