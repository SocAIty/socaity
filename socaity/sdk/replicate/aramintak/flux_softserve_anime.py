...
class flux_softserve_anime(FastClient):
    """
    Generated client for aramintak/flux-softserve-anime
    """
    def __init__(self, api_key: str = None):
        super().__init__(service_name_or_id="9bf2b7ee-b0a0-4dcb-88a6-a1d3dc359c1f", api_key=api_key)
