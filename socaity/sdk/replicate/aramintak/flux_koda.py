...
class flux_koda(FastClient):
    """
    Generated client for aramintak/flux-koda
    """
    def __init__(self, api_key: str = None):
        super().__init__(service_name_or_id="b4579766-7a0b-476f-9183-9abb04175cdd", api_key=api_key)
