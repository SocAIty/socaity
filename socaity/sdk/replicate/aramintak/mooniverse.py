...
class mooniverse(FastClient):
    """
    Generated client for aramintak/mooniverse
    """
    def __init__(self, api_key: str = None):
        super().__init__(service_name_or_id="31e4798b-0278-409a-af2e-e35a7adb4133", api_key=api_key)
