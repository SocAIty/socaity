...
class flux_film_foto(FastClient):
    """
    Generated client for aramintak/flux-film-foto
    """
    def __init__(self, api_key: str = None):
        super().__init__(service_name_or_id="d147ed71-2f78-4404-ae2c-e5a9c550eba8", api_key=api_key)
