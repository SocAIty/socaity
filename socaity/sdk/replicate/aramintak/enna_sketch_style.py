...
class enna_sketch_style(FastClient):
    """
    Generated client for aramintak/enna-sketch-style
    """
    def __init__(self, api_key: str = None):
        super().__init__(service_name_or_id="f2af77de-6d43-4827-b515-2574713565cb", api_key=api_key)
