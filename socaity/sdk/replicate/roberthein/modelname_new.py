...
class modelname_new(FastClient):
    """
    Generated client for roberthein/modelname-new
    """
    def __init__(self, api_key: str = None):
        super().__init__(service_name_or_id="e9fd780b-2a80-4dc2-8d9c-2edcc3949588", api_key=api_key)
