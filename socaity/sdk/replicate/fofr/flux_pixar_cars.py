...
class flux_pixar_cars(FastClient):
    """
    Generated client for fofr/flux-pixar-cars
    """
    def __init__(self, api_key: str = None):
        super().__init__(service_name_or_id="4bda14b8-ddcc-4a06-b0f2-14a93b7ae9c8", api_key=api_key)
