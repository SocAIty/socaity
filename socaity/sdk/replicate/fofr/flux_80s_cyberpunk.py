...
class flux_80s_cyberpunk(FastClient):
    """
    Generated client for fofr/flux-80s-cyberpunk
    """
    def __init__(self, api_key: str = None):
        super().__init__(service_name_or_id="5977bc5a-581e-400e-86f2-1cc8155c83c2", api_key=api_key)
