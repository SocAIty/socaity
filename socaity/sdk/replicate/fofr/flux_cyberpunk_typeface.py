...
class flux_cyberpunk_typeface(FastClient):
    """
    Generated client for fofr/flux-cyberpunk-typeface
    """
    def __init__(self, api_key: str = None):
        super().__init__(service_name_or_id="7009087f-2427-4c72-82c6-c429ef6a1bfa", api_key=api_key)
