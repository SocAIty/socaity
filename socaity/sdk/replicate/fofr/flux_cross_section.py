...
class flux_cross_section(FastClient):
    """
    Generated client for fofr/flux-cross-section
    """
    def __init__(self, api_key: str = None):
        super().__init__(service_name_or_id="b514daaa-4e8b-4abf-8ed6-297524cc4abb", api_key=api_key)
