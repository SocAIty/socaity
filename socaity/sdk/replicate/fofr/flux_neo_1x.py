...
class flux_neo_1x(FastClient):
    """
    Generated client for fofr/flux-neo-1x
    """
    def __init__(self, api_key: str = None):
        super().__init__(service_name_or_id="2cee896e-89ce-4500-bc16-31289cfaa3b8", api_key=api_key)
