...
class flux_brighton_west_pier(FastClient):
    """
    Generated client for fofr/flux-brighton-west-pier
    """
    def __init__(self, api_key: str = None):
        super().__init__(service_name_or_id="8b77654e-f547-4e5c-b828-46c0bd97ff15", api_key=api_key)
