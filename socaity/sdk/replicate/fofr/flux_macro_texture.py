...
class flux_macro_texture(FastClient):
    """
    Generated client for fofr/flux-macro-texture
    """
    def __init__(self, api_key: str = None):
        super().__init__(service_name_or_id="99d424fe-f6bf-4717-8dd8-5a0857d8d09a", api_key=api_key)
