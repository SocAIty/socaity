...
class flux_tessellate(FastClient):
    """
    Generated client for fofr/flux-tessellate
    """
    def __init__(self, api_key: str = None):
        super().__init__(service_name_or_id="3630ed27-29b4-4f85-b342-5743da5f1ba7", api_key=api_key)
