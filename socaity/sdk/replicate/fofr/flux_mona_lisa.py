...
class flux_mona_lisa(FastClient):
    """
    Generated client for fofr/flux-mona-lisa
    """
    def __init__(self, api_key: str = None):
        super().__init__(service_name_or_id="44c2998a-95fa-41d2-b4c0-1181331795bf", api_key=api_key)
