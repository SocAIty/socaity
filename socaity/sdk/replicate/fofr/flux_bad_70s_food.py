...
class flux_bad_70s_food(FastClient):
    """
    Generated client for fofr/flux-bad-70s-food
    """
    def __init__(self, api_key: str = None):
        super().__init__(service_name_or_id="aa50eb77-b3f2-4d4c-bf14-7fef4253045c", api_key=api_key)
