...
class flux_spitting_image(FastClient):
    """
    Generated client for fofr/flux-spitting-image
    """
    def __init__(self, api_key: str = None):
        super().__init__(service_name_or_id="ee33de7c-b5e7-4e85-91c7-516e08e238ae", api_key=api_key)
