...
class flux_minecraft_movie(FastClient):
    """
    Generated client for fofr/flux-minecraft-movie
    """
    def __init__(self, api_key: str = None):
        super().__init__(service_name_or_id="6b4186ee-2d78-4c1d-a99f-19c4d5773128", api_key=api_key)
