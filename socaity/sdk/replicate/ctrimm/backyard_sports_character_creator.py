...
class backyard_sports_character_creator(FastClient):
    """
    Generated client for ctrimm/backyard-sports-character-creator
    """
    def __init__(self, api_key: str = None):
        super().__init__(service_name_or_id="3e12573a-a61e-4061-9b9b-739997bd7e26", api_key=api_key)
