...
class _90sbadtrip(FastClient):
    """
    Generated client for markredito/90sbadtrip
    """
    def __init__(self, api_key: str = None):
        super().__init__(service_name_or_id="19f3ce52-cbe1-427e-9c7a-7a4fd28612fb", api_key=api_key)
