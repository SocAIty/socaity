...
class rolxsub(FastClient):
    """
    Generated client for sevensevenimages/rolxsub
    """
    def __init__(self, api_key: str = None):
        super().__init__(service_name_or_id="6cbcccee-c915-455d-8cc6-05534ed1394a", api_key=api_key)
