...
class qwen_image_edit(FastClient):
    """
    Generated client based on qwen/qwen-image-edit format
    """
    def __init__(self, api_key: str = None):
        super().__init__(service_name_or_id="ac19a9e9-9626-46d1-83e5-3970534c1313", api_key=api_key)
    
    def predictions(self, image: MediaFile, prompt: str, seed: int = 42, go_fast: bool = True, aspect_ratio: Literal["1:1", "16:9", "9:16", "4:3", "3:4", "match_input_image"] = 'match_input_image', output_format: Literal["webp", "jpg", "png"] = 'webp', output_quality: int = 95, disable_safety_checker: bool = False, **kwargs) -> APISeex:
        """
        
        
        
        Args:
            image: Image to use as reference. Must be jpeg, png, gif, or webp.
