...
class flux_dev_woodcut_prints(FastClient):
    """
    Generated client for tjrndll/flux-dev-woodcut-prints
    """
    def __init__(self, api_key: str = None):
        super().__init__(service_name_or_id="73dd6527-f19d-4a9d-9de0-e623d51dd012", api_key=api_key)
