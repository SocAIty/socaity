...
class yanisse(FastClient):
    """
    Generated client for alexvoorheesmusic/yanisse
    """
    def __init__(self, api_key: str = None):
        super().__init__(service_name_or_id="8aaf6fab-86e2-4e07-a138-309af7f456cd", api_key=api_key)
