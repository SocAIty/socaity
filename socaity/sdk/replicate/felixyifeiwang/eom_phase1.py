...
class eom_phase1(FastClient):
    """
    Generated client for felixyifeiwang/eom-phase1
    """
    def __init__(self, api_key: str = None):
        super().__init__(service_name_or_id="60814f7b-dcff-4cd2-af27-904c4d210013", api_key=api_key)
