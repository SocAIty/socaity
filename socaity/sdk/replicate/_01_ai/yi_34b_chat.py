...
class yi_34b_chat(FastSDK):
    """
    Generated client for yi_34b_chat
    """
    def __init__(self, api_key: str = None):
        super().__init__(service_name_or_id="0068a155-b1c3-438b-926e-32d726c87182", api_key=api_key)
    ...
    def predict(self, prompt: str, top_k: int = 50, top_p: float = 0.8, temperature: float = 0.3, max_new_tokens: int = 1024, prompt_template: str = '<|im_start|>system\nYou are a helpful assistant<|im_end|>\n<|im_start|>user\n{prompt}<|im_end|>\n<|im_start|>assistant\n', repetition_penalty: float = 1.2, **kwargs):
        ...
        """
        return self.submit_job("/predict", prompt=prompt, top_k=top_k, top_p=top_p, temperature=temperature, max_new_tokens=max_new_tokens, prompt_template=prompt_template, repetition_penalty=repetition_penalty, **kwargs)
