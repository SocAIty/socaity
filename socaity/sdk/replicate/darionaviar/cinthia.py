...
class cinthia(FastClient):
    """
    Generated client for darionaviar/cinthia
    """
    def __init__(self, api_key: str = None):
        super().__init__(service_name_or_id="d473c5de-0505-451b-beca-f3a4dcd991f3", api_key=api_key)
