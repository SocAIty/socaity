...
class bonkfa(FastClient):
    """
    Generated client for -10xcrazyhorse/bonkfa
    """
    def __init__(self, api_key: str = None):
        super().__init__(service_name_or_id="d41c2c83-6ec9-4a2d-9f51-ee8b73e815d2", api_key=api_key)
