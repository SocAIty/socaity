...
class deepfits_flux_dev(FastClient):
    """
    Generated client for deepfates/deepfits-flux-dev
    """
    def __init__(self, api_key: str = None):
        super().__init__(service_name_or_id="8a19653e-673c-43c9-a448-8719e3ff2280", api_key=api_key)
