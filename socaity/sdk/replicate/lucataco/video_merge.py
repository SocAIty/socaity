...
class video_merge(FastClient):
    """
    Generated client based on lucataco/video-merge format
    """
    def __init__(self, api_key: str = None):
        super().__init__(service_name_or_id="0a9bb226-1d9f-4252-bff3-7a5de0c58d55", api_key=api_key)
    
    def predictions(self, video_files: List[MediaFile], fps: int = 0, width: int = 0, height: int = 0, keep_audio: bool = True, **kwargs) -> APISeex:
        """
