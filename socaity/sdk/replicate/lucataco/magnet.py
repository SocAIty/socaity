...
class magnet(FastSDK):
    """
    Generated client for magnet
    """
    def __init__(self, api_key: str = None):
        super().__init__(service_name_or_id="f54e16b2-58f0-4af0-ab6a-fb048ac86968", api_key=api_key)
    
    def predict(self, model: str = 'facebook/magnet-small-10secs', top_p: float = 0.9, prompt: str = '80s electronic track with melodic synthesizers, catchy beat and groovy bass', max_cfg: float = 10.0, min_cfg: float = 1.0, span_score: str = 'prod-stride1', variations: int = 3, temperature: float = 3.0, decoding_steps_stage_1: int = 20, decoding_steps_stage_2: int = 10, decoding_steps_stage_3: int = 10, decoding_steps_stage_4: int = 10, **kwargs):
        """
