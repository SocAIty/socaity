...
class demofusion_enhance(FastSDK):
    """
    Generated client for demofusion_enhance
    """
    def __init__(self, api_key: str = None):
        super().__init__(service_name_or_id="7d02018f-881f-40a0-88d2-6aa3a197784a", api_key=api_key)
