...
class flux_vlta(FastClient):
    """
    Generated client for lucataco/flux-vlta
    """
    def __init__(self, api_key: str = None):
        super().__init__(service_name_or_id="230255d2-cf31-4fa5-8069-21aac36284d0", api_key=api_key)
