...
class photo_glow(FastClient):
    """
    Generated client for davisbrown/photo-glow
    """
    def __init__(self, api_key: str = None):
        super().__init__(service_name_or_id="936bc9e8-5848-42b1-a7e0-bcfda4ffac9f", api_key=api_key)
