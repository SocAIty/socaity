...
class adsgenerator(FastClient):
    """
    Generated client based on sisyphos55/adsgenerator format
    """
    def __init__(self, api_key: str = None):
        super().__init__(service_name_or_id="0898df7b-afff-4e8c-9ca0-f89c14f0f6ab", api_key=api_key)
