...
class flux_andreas(FastClient):
    """
    Generated client for esgfit/flux-andreas
    """
    def __init__(self, api_key: str = None):
        super().__init__(service_name_or_id="1be6bbd4-7ea6-4a03-b36a-3175cffbe233", api_key=api_key)
