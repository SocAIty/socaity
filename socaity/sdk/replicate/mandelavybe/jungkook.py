...
class jungkook(FastClient):
    """
    Generated client for mandelavybe/jungkook
    """
    def __init__(self, api_key: str = None):
        super().__init__(service_name_or_id="7f55a287-e33a-4274-bf92-00a637c9b914", api_key=api_key)
