...
class tst_svt3(FastClient):
    """
    Generated client for dunaevai135/tst-svt3
    """
    def __init__(self, api_key: str = None):
        super().__init__(service_name_or_id="2d83d386-55a9-476d-8c09-0605aa7b5ef4", api_key=api_key)
