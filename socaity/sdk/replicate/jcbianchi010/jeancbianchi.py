...
class jeancbianchi(FastClient):
    """
    Generated client for jcbianchi010/jeancbianchi
    """
    def __init__(self, api_key: str = None):
        super().__init__(service_name_or_id="9720e175-17ec-4e53-8e18-c1b3e6a1d365", api_key=api_key)
