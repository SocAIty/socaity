...
class bmayb(FastClient):
    """
    Generated client for maybasmanphotographer/bmayb
    """
    def __init__(self, api_key: str = None):
        super().__init__(service_name_or_id="242ac0d5-c2e3-4cc8-8691-1190a6cca4b8", api_key=api_key)
