...
class gpt_4o_mini(FastClient):
    """
    Generated client based on openai/gpt-4o-mini format
    """
    def __init__(self, api_key: str = None):
        super().__init__(service_name_or_id="09f23f97-71ce-49b0-b6a6-9817472c703f", api_key=api_key)
