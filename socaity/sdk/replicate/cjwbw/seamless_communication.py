...
class seamless_communication(FastSDK):
    """
    Generated client for seamless_communication
    """
    def __init__(self, api_key: str = None):
        super().__init__(service_name_or_id="3a3cbb40-c0d4-4aed-a6d6-e5c0737de4ab", api_key=api_key)
    ...
    def predict(self, task_name: str = 'S2ST (Speech to Speech translation)', input_text_language: str = 'None', max_input_audio_length: float = 60.0, target_language_text_only: str = 'Norwegian Nynorsk', target_language_with_speech: str = 'French', input_text: Optional[str] = None, input_audio: Optional[Union[MediaFile, str, bytes]] = None, **kwargs):
        ...
        """
        return self.submit_job("/predict", task_name=task_name, input_text_language=input_text_language, max_input_audio_length=max_input_audio_length, target_language_text_only=target_language_text_only, target_language_with_speech=target_language_with_speech, input_text=input_text, input_audio=input_audio, **kwargs)
