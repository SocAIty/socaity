...
# Add the endpoints to the services dynamically when created..?
...
GenerativeModelEndpoints = [
    ...
    ### TEXT2VOICE
        ## Bark
            #hosted
            SocaityServerEndpoint(model_type=ModelTag.TEXT2VOICE, model_name="bark"),
            #localhost
            LocalEndPoint(
   ...
   ### FACE2FACE
        # hosted
        SocaityServerEndpoint(model_type=ModelTag.FACE2FACE, model_name="face2face"),
        LocalEndPoint(
