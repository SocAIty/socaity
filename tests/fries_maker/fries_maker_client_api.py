...
class FriesMaker:
    ...
    @fries_maker_client_api.job()
    def _make_image_fries(self, job: InternalJob, potato_one: bytes, potato_two: bytes):
        endpoint_request = job.request_sync(
            endpoint_route="make_image_fries", potato_one=potato_one, potato_two=potato_two
        )
    ...
    def make_image_fries(self, potato_one: str, potato_two: str) -> List[InternalJob]:
        """
        ...
        # read with cv2
        potato_three = cv2.imread(potato_two)
